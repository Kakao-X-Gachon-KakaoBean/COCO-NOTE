...
context('Local Storage / Session Storage', () => {
  ...
  it('cy.clearLocalStorage() - clear all index in localStorage for the current origin', () => {
  ...
  it('cy.getAllLocalStorage() - get all index in localStorage for all origins', () => {
  ...
  it('cy.clearAllLocalStorage() - clear all index in localStorage for all origins', () => {
  ...
  it('cy.getAllSessionStorage() - get all index in sessionStorage for all origins', () => {
  ...
  it('cy.clearAllSessionStorage() - clear all index in sessionStorage for all origins', () => {
